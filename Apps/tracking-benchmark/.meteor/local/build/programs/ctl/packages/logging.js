...
Log.format = function (obj, options) {                                                 // 187
  ...
  var sourceInfo = (file && lineNumber) ?                                              // 238
      ...
      : '';                                                                            // 240
                                                                                       // 241
  if (satellite)                                                                       // 242
    sourceInfo += ['[', satellite, ']'].join('');                                      // 243
                                                                                       // 244
  var stderrIndicator = stderr ? '(STDERR) ' : '';                                     // 245
                                                                                       // 246
  var metaPrefix = [                                                                   // 247
    level.charAt(0).toUpperCase(),                                                     // 248
    dateStamp,                                                                         // 249
    '-',                                                                               // 250
    timeStamp,                                                                         // 251
    utcOffsetStr,                                                                      // 252
    ...
    appInfo,                                                                           // 254
    sourceInfo,                                                                        // 255
    stderrIndicator].join('');                                                         // 256
                                                                                       // 257
  var prettify = function (line, color) {                                              // 258
    return (options.color && Meteor.isServer && color) ?                               // 259
      Npm.require('cli-color')[color](line) : line;                                    // 260
  };                                                                                   // 261
                                                                                       // 262
  return prettify(metaPrefix, META_COLOR)                                              // 263
    + prettify(message, LEVEL_COLORS[level]);                                          // 264
};                                                                                     // 265
                                                                                       // 266
// Turn a line of text into a loggable object.                                         // 267
// @param line {String}                                                                // 268
// @param override {Object}                                                            // 269
Log.objFromText = function (line, override) {                                          // 270
  var obj = {message: line, level: "info", time: new Date(), timeInexact: true};       // 271
  return _.extend(obj, override);                                                      // 272
};                                                                                     // 273
                                                                                       // 274
/////////////////////////////////////////////////////////////////////////////////////////
